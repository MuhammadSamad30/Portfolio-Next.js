...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Generate and download your personal ID card. Built using HTML, CSS, and JavaScript.",
    icon: "bx-id-card",
  ...
  },
  {
    ...
    description:
      "A simple Currency Converter app to convert your amount built using JavaScript.",
    icon: "bxl-bitcoin",
